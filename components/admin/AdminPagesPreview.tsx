    ...
    rows: [
      {
        ...
        cells: [
          ...
          { badge: { label: "Enterprise Legacy", tone: "accent" }, meta: "1.420 / 3.000 Credits" },
      ...
      },
      {
        ...
        cells: [
          ...
          { badge: { label: "Trial" }, meta: "220 / 300 Credits · einmalig" },
      ...
      },
      {
        ...
        cells: [
          ...
          { badge: { label: "Trial" }, meta: "300 / 300 Credits · einmalig" },
    ...
    rows: [
      {
        ...
        cells: [
          ...
          { badge: { label: "Enterprise Legacy", tone: "accent" }, meta: "3.000 Credits / Monat" },
      ...
      },
      {
        ...
        cells: [
          ...
          { badge: { label: "Trial" }, meta: "300 Credits einmalig" },
